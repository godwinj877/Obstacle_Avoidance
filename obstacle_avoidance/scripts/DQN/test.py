...
GOALS = [[3.0, -1.0], [-1.0, -3.0], [1.0, 1.0], [5.0, 0.0]]
        ...
        for goal in GOALS: 
            ...
            while episode < MAX_EPISODES:
                ...
                while step < MAX_STEPS_PER_EPISODE:
                    print(f"Episode {episode} | step {step} for goal: {goal}")
                    ...
                    # Checking for goal
                    if relative_distance < 0.3 and step != 1:
                        self.reached = True
                ...
                np.savetxt(LOG_FILE_DIR+f'{self.sim_start_time}'+f'/result/episode_{episode}_step_reward.csv', step_reward, delimiter=' , ')
